...
public interface IWorkManager
{
     ...
     */
    void removeWorkOrder(@NotNull AbstractWorkOrder order);
     ...
     */
    @Nullable
    <W extends AbstractWorkOrder> W getWorkOrder(int id, @NotNull Class<W> type);
     ...
     */
    AbstractWorkOrder getWorkOrder(int id);
     ...
     */
    @Nullable
    <W extends AbstractWorkOrder> W getUnassignedWorkOrder(@NotNull Class<W> type);
     ...
     */
    <W extends AbstractWorkOrder> List<W> getWorkOrdersOfType(@NotNull Class<W> type);
     ...
     */
    @NotNull
    Map<Integer, AbstractWorkOrder> getWorkOrders();
     ...
     */
    void addWorkOrder(@NotNull AbstractWorkOrder order);
