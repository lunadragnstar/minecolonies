...
public final class BlockPosUtil
{
     ...
     */
    public static boolean isClose(@NotNull final BlockPos coordinate, @NotNull final IEntityCitizen citizen)
    {
     ...
     * {@link EntityUtils#isPathingTo(IEntityCitizen, int, int)}.
     *
     ...
     */
    public static boolean isPathingTo(@NotNull final IEntityCitizen citizen, @NotNull final BlockPos pos)
    {
        return EntityUtils.isPathingTo(citizen, pos.getX(), pos.getZ());
    }

    /**
     * {@link EntityUtils#isWorkerAtSiteWithMove(IEntityCitizen, int, int, int)}.
     *
     * @param worker Worker to check.
     * @param site   Chunk coordinates of site to check.
     * @return True when worker is at site, otherwise false.
     */
    public static boolean isWorkerAtSiteWithMove(@NotNull final IEntityCitizen worker, @NotNull final BlockPos site)
    {
        return EntityUtils.isWorkerAtSiteWithMove(worker, site.getX(), site.getY(), site.getZ());
    }

    /**
     * {@link EntityUtils#isWorkerAtSiteWithMove(IEntityCitizen, int, int, int, int)}.
     *
     * @param worker Worker to check.
     * @param site   Chunk coordinates of site to check.
     ...
     */
    public static boolean isWorkerAtSiteWithMove(@NotNull final IEntityCitizen worker, @NotNull final BlockPos site, final int range)
    {
