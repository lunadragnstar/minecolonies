package com.minecolonies.skeleton.colony.building;
...
public abstract class AbstractBuilding implements IBuilding
{
    ...
    TODO: Move to intialization Package!!!!!!!!!!!!!!!!!!!!
    ...
    */
     ...
     */
    @Nullable
    public static IBuilding create(IColony colony, @NotNull TileEntity parent)
    {
        ...
        try
        {
            oclass = AbstractBuilding.blockClassToBuildingClassMap.get(parent.getBlockType().getClass());
            ...
            final BlockPos loc = parent.getPos();
            final Constructor<?> constructor = oclass.getDeclaredConstructor(IColony.class, BlockPos.class);
     ...
     * <code>parentBlock</code> needs to extend {@link Block}.
     *
    ...
    private static void addMapping(
            ...
            @NotNull final Class<? extends Block> parentBlock)
    {
        ...
        else
        {
            try
            {
                 ...
                 */
                if (buildingClass.getDeclaredConstructor(IColony.class, BlockPos.class) != null)
                {
     ...
     */
    @Nullable
    public static IBuilding createFromNBT(final IColony colony, @NotNull final NBTTagCompound compound)
    {
        @Nullable IBuilding building = null;
        ...
        try
        {
            ...
            if (oclass != null)
            {
                ...
                final Constructor<?> constructor = oclass.getDeclaredConstructor(IColony.class, BlockPos.class);
                building = (IBuilding) constructor.newInstance(colony, pos);
            }
        }
        catch (@NotNull NoSuchMethodException | InstantiationException | InvocationTargetException | IllegalAccessException exception)
        {
     ...
     */
    @Nullable
    public static View createBuildingView(final IColony colony, final BlockPos id, @NotNull final ByteBuf buf)
    {
