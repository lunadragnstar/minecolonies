...
public abstract class AbstractBuildingWorker extends AbstractBuildingHut
{
     ...
     */
    @NotNull
    public abstract IJob createJob(ICitizenData citizen);
    ...
    public void setWorker(final ICitizenData citizen)
    {
        ...
        if (worker != null)
        {
            final IEntityCitizen tempCitizen = worker.getCitizenEntity();
        ...
        if (worker != null)
        {
            final IEntityCitizen tempCitizen = citizen.getCitizenEntity();
     ...
     */
    @Nullable
    public IEntityCitizen getWorkerEntity()
    {
        if (worker == null)
        {
            return null;
