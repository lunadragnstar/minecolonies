...
import com.minecolonies.api.entity.pathfinding.WalkToProxy;
    ...
    protected AbstractEntityAIBasic(@NotNull final J job)
    {
        ...
        super.registerTargets(
          ...
          new AITarget(() -> this.getOwnBuilding().needsWeapon(), this::waitForWeapon),
                 ...
                 * to resolve state.
                 */
          new AITarget(AIState.INVENTORY_FULL, this::dumpInventory),
                /*
                 * Check if inventory has to be dumped.
                 */
          new AITarget(this::inventoryNeedsDump, AIState.INVENTORY_FULL)
        );
    }
