package com.minecolonies.skeleton.ai;
...
public abstract class AbstractEntityAIStructure<J extends AbstractJob> extends AbstractEntityAIInteract<J>
{
    ...
    protected AbstractEntityAIStructure(@NotNull final J job)
    {
        ...
        this.registerTargets(
                 ...
                 */
                new AITarget(this::checkIfCanceled, AIState.IDLE),
                /**
                 ...
                 */
                new AITarget(AIState.IDLE, this::isThereAStructureToBuild, () -> AIState.START_BUILDING),
                /**
                 * Clear out the building area.
                 */
                new AITarget(AIState.CLEAR_STEP, generateStructureGenerator(this::clearStep, AIState.BUILDING_STEP)),
                /**
                 * Build the structure and foundation of the building.
                 */
                new AITarget(AIState.BUILDING_STEP, generateStructureGenerator(this::structureStep, AIState.SPAWN_STEP)),
                /**
                 * Spawn entities on the structure.
                 */
                new AITarget(AIState.SPAWN_STEP, generateStructureGenerator(this::spawnEntity, AIState.DECORATION_STEP)),
                /**
                 * Decorate the AbstractBuilding with torches etc.
                 */
                new AITarget(AIState.DECORATION_STEP, generateStructureGenerator(this::decorationStep, AIState.COMPLETE_BUILD)),
                /**
                 * Finalize the building and give back control to the ai.
                 */
                new AITarget(AIState.COMPLETE_BUILD, this::completeBuild)
        );
    }
