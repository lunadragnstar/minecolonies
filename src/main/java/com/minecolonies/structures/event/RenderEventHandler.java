...
public class RenderEventHandler
{
    ...
    public void onRenderWorldLast(final RenderWorldLastEvent event)
    {
        ...
        if (structure != null)
        {
            ...
            structure.renderStructure(position, Minecraft.getMinecraft().world, Minecraft.getMinecraft().player, event.getPartialTicks(), Settings.instance.isWithSubstitutionBlock());
        }
    }
}
